...
//                                                   UITextAttributeFont,
                                                   nil];
    [[FUISegmentedControl appearance] setTitleTextAttributes:selectedAttributesDictionary forState:UIControlStateSelected];
...
//                                                   UITextAttributeFont,
                                                   nil];
    [[FUISegmentedControl appearance] setTitleTextAttributes:deselectedAttributesDictionary forState:UIControlStateNormal];
}
