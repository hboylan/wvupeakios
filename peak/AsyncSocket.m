...
- (void)doAcceptFromSocket:(CFSocketRef)parentSocket withNewNativeSocket:(CFSocketNativeHandle)newNativeSocket
{
	if(newNativeSocket)
	{
		...
		{
			NSRunLoop *runLoop = [theDelegate onSocket:self wantsRunLoopForNewSocket:newSocket];
...
- (NSData *)connectedAddress
{
    ...
    if (theSocket)
    {
		...
		return (NSData *)CFBridgingRelease(peeraddr);
	}
...
- (NSData *)localAddress
{
    ...
    if (theSocket)
    {
		...
		return (NSData *)CFBridgingRelease(selfaddr);
	}
